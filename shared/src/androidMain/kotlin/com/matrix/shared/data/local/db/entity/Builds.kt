...
//) {
//  actual fun com.matrix.shared.data.model.toDomain(): BuildInformation = BuildInformation(
//    id = build.id,
//    name = build.name,
//    god = god.com.matrix.shared.data.model.toDomain(),
//    items = items.map { it.com.matrix.shared.data.model.toDomain() },
//  )
//}
